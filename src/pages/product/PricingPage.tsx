  ...
  const plans = [
    {
      ...
      features: [
        ...
        { name: 'Работы, акты и платежи', included: true },
    ...
    },
    {
      ...
      featured: true,
      features: [
        { name: '3 прораба', included: true },
        { name: '5 проектов', included: true },
        { name: '7 пользователей', included: true },
        { name: '3 ГБ хранилища', included: true },
        { name: 'График и заявки с объекта', included: true },
        { name: 'Мобильное приложение', included: true },
        { name: 'Поддержка по почте', included: true },
        { name: 'Расширенные направления', included: false },
        { name: 'Индивидуальные условия', included: false }
      ],
      cta: 'Выбрать',
    ...
    },
    {
      ...
      price: '24 900',
      period: '₽/мес',
      description: '8 прорабов, 20 проектов, снабжение и финансы',
      featured: false,
      features: [
        { name: '8 прорабов', included: true },
        { name: '20 проектов', included: true },
        { name: '15 пользователей', included: true },
        { name: '10 ГБ хранилища', included: true },
        { name: 'Снабжение и склад', included: true },
        { name: 'Финансы и акты', included: true },
        { name: 'Базовая помощь при запуске', included: true },
        { name: 'ПТО, холдинг и AI', included: false },
        { name: 'Индивидуальные условия', included: false }
      ],
      cta: 'Выбрать',
    ...
    },
    {
      ...
      price: '39 900',
      period: '₽/мес',
      description: '20 прорабов, 50 проектов, ПТО и аналитика',
      featured: false,
      features: [
        { name: '20 прорабов', included: true },
        { name: '50 проектов', included: true },
        { name: '40 пользователей', included: true },
        { name: '25 ГБ хранилища', included: true },
        { name: 'ПТО, аналитика и AI-возможности', included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { name: 'Интеграции по согласованному плану', included: true }
      ],
