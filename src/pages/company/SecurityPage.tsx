  ...
  return (
    <div className="bg-white pt-28">
      <PageHero
        ...
        title="Страница безопасности стала частью корпоративного narrative, а не техническим приложением."
        description="Здесь собраны основные принципы, которые важны заказчику на этапе оценки продукта: роли, документы, прозрачность действий и поддержка проектного запуска."
        actions={[
        ...
        aside={
          <div className="rounded-[1.75rem] border border-steel-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 grid gap-3">
              {[
                'Страница помогает снять базовые корпоративные возражения еще до звонка.',
                'Безопасность объясняется через бизнес-пользу, а не через перегруженный техтекст.',
                'Маркетинговый слой теперь естественно ведет к обсуждению прав доступа и документов.',
              ].map((item) => (
                <div
                  key={item}
        ...
        <div className="container-custom grid gap-8 xl:grid-cols-[minmax(0,0.94fr)_minmax(0,1.06fr)]">
          <div>
            <SectionHeader
              ...
              description="Страница показывает это на конкретных примерах из продуктовых контуров, а не только на уровне общих формулировок."
            />
          ...
          <div>
            <SectionHeader
              ...
              description="Именно поэтому в новой публичной подаче акцент сделан на роли, прозрачность процессов и понятную модель проектного запуска."
            />
            <div className="mt-8">
