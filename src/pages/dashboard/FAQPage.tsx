...
const faqData = [
  ...
  },
  {
    ...
    answer: "В настоящее время функция пополнения баланса через интерфейс временно недоступна. При регистрации вам автоматически выдается тестовый баланс в размере 30 000 рублей для ознакомления с возможностями платформы. Вы можете просматривать текущий баланс и историю транзакций в разделе 'Биллинг'."
  },
  {
    id: 'q4',
