        ...
        <header className="border-b border-slate-200 pb-7">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            <div className="max-w-3xl">
              <p className="text-xs font-bold uppercase tracking-[0.22em] text-orange-600">Возможности организации</p>
            ...
            <div className="relative flex items-center gap-3">
              <button
                type="button"
                onClick={() => void refresh()}
                className="inline-flex items-center gap-2 rounded-2xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-bold text-slate-700 shadow-sm transition hover:border-orange-200 hover:text-orange-700"
              >
...
const SolutionsSection = ({
  ...
  <section className="space-y-5">
    <div className="flex items-end justify-between gap-4">
      <div>
        <p className="text-xs font-bold uppercase tracking-[0.22em] text-orange-600">Основной сценарий</p>
        <h2 className="mt-1 text-2xl font-black tracking-tight text-slate-950">Решения</h2>
    ...
    <div className="grid gap-4 lg:grid-cols-2 xl:grid-cols-3">
      {solutions.map((solution, index) => (
        <motion.article
          ...
          className="group relative flex min-h-[330px] flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white p-5 transition duration-200 hover:border-orange-200 hover:shadow-sm"
        >
...
const StandaloneModulesSection = ({
  ...
  <section className="space-y-5 pb-10">
    <div>
      <p className="text-xs font-bold uppercase tracking-[0.22em] text-orange-600">Точечные подключения</p>
      <h2 className="mt-1 text-2xl font-black tracking-tight text-slate-950">Отдельные возможности</h2>
    ...
    {modules.length === 0 ? (
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        {modules.map(module => (
          <article key={module.slug} className="rounded-3xl border border-slate-200 bg-white p-5 transition hover:border-orange-200 hover:shadow-sm">
