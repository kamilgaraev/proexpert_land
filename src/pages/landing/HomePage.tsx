...
const teamRoleItems = [
  {
    role: "Руководитель",
    text: "Сводка руководителя показывает объекты, платежи, сроки, риски и зафиксированные отклонения.",
  },
  {
    role: "Прораб",
  ...
  return (
    <div className="marketing-page-shell overflow-hidden">
      <PageHero
        ...
        description="МОСТ — система для ежедневной работы строительной компании. Сводка по объектам показывает сроки, ответственных, материалы, платежи и зафиксированные отклонения."
        actions={[
