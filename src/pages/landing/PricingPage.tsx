      ...
      >
        <div className="most-container most-pricing-foundation">
          ...
          <div>
            ...
            <p>{freeFoundationOffer.limitsNote}</p>
          </div>
        </div>
      </section>
        ...
        <div className="most-container most-capabilities-layout">
          ...
          <div className="most-capability-details">
            ...
            <details>
              ...
              <p>
                Полный расчётный период — 30 дней. Если добавить пакет в
                середине текущего периода, сумма рассчитывается за оставшееся
                время. Итоговая стоимость и дата продления показаны в личном
                кабинете перед оплатой.
              </p>
            </details>
            <details>
              <summary>
              ...
              <p>
                Если включено автопродление и сохранён способ оплаты, при
                неуспешном списании предусмотрено до {commercialTerms.graceDays}{" "}
                дней на оплату. Без автопродления или сохранённого способа
                оплаты пакет может приостановиться в конце оплаченного периода.
                Поздняя оплата не переносит расчётную дату.
              </p>
            </details>
            <details>
              <summary>
