        ...
        actions={
          <>
            ...
            <button 
              ...
              className="bg-gradient-to-r from-orange-500 to-blue-600 text-white px-6 py-3 rounded-xl flex items-center gap-2 font-semibold shadow-lg hover:shadow-xl transition-all"
            >
      ...
      {filteredOrganizations.length === 0 ? (
        <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-12 text-center">
          ...
          <button 
            ...
            className="bg-gradient-to-r from-orange-500 to-blue-600 text-white px-8 py-4 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all"
          >
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex gap-2">
                  <button 
                    className="flex-1 bg-gradient-to-r from-orange-500 to-blue-600 text-white py-2 px-4 rounded-xl text-sm font-medium hover:shadow-lg transition-all flex items-center justify-center gap-1"
                  >
        ...
        footer={
          <div className="flex gap-3">
            ...
            <button
              ...
              disabled={savingOrg}
              className="flex-1 bg-gradient-to-r from-orange-500 to-blue-600 text-white py-3 px-4 rounded-xl font-medium hover:shadow-lg transition-all disabled:opacity-50"
            >
