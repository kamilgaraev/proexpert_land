...
export const createWorkspaceFixture = (): BuilderWorkspaceData => {
  ...
  return {
    site: {
      ...
      is_published: false,
      published_at: null,
      url: 'https://alpha.1мост.рф',
      preview_url: 'https://alpha.1мост.рф/?preview=true&token=preview-token',
    ...
    publication: {
      ...
      published_at: null,
      preview_url: 'https://alpha.1мост.рф/?preview=true&token=preview-token',
      public_url: 'https://alpha.1мост.рф',
      has_snapshot: false,
    },
  };
};
...
export const createLeadFixture = (): LeadEntry => ({
  ...
  source_url: 'https://alpha.1мост.рф',
  status: 'new',
