  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <button className="bg-primary hover:bg-orange-700 text-white px-4 py-2 rounded-lg font-medium">
      ...
      {users.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Начните с приглашения участников</p>
        </div>
      ) : (
              ...
              {users.map((user) => (
                <tr key={user.id} className="hover:bg-secondary/50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <button className="text-primary hover:text-orange-700 font-medium">
                      Редактировать
                    </button>
                  </td>
                </tr>
