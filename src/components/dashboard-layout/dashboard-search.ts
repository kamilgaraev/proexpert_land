...
const contextualSearchItems: ContextualSearchItem[] = [
  ...
  {
    name: 'Лимиты подписки',
    href: '/dashboard/limits',
    description: 'Ограничения тарифа и доступные объемы',
    aliases: ['лимиты', 'ограничения', 'подписка'],
    priority: 60,
  ...
  },
  {
    ...
    description: 'Каталог дополнительных услуг',
    aliases: ['услуги', 'каталог услуг', 'дополнительные услуги'],
    priority: 58,
    requireHref: '/dashboard/billing',
  },
  {
