...
const moduleDisplayNames: Record<string, string> = {
  ...
  brigades: 'Бригады',
  'workflow-management': 'Выполненные работы',
  ...
  procurement: 'Закупки',
  payments: 'Платежи',
  'act-reporting': 'Акты выполненных работ',
  'advance-accounting': 'Авансы и подотчет',
  'budget-estimates': 'Сметы',
  'design-management': 'ПИР и проектная документация',
  ...
  'workforce-management': 'Персонал и трудозатраты',
  'change-management': 'Изменения и претензии',
