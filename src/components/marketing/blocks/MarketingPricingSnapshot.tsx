    ...
    <div className="container-custom">
      <div className="grid gap-8 xl:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)] xl:items-end">
        <SectionHeader
          ...
          title="Бесплатная база и пакеты под задачи стройки"
          description="Регистрация открывает полезную ограниченную основу. Затем можно подключить отдельные бизнес-пакеты или полный комплект — без выбора старого тарифного уровня."
        />
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-3">
        <article className="rounded-[1.55rem] border border-steel-200 bg-white p-6 shadow-sm">
          ...
          <Link to="/register" className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-steel-950">
            Создать бесплатную базу <ArrowUpRightIcon className="h-4 w-4" />
          </Link>
        </article>
        <article className="rounded-[1.55rem] border border-steel-700 bg-steel-950 p-6 text-white shadow-sm">
          ...
          <p className="mt-3 text-sm leading-7 text-white/70">Каждый пакет действует 30 дней и получает отдельный 72-часовой пробный период без карты.</p>
