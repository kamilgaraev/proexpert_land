    ...
    >
      ...
      <section className="bg-concrete-50 py-16 lg:py-20">
        <div className="container-custom">
          <SectionHeader
            eyebrow="Темы блога"
            title="Три серии материалов под роли, боли и процессы стройки."
            description="Собрали направления блога так, чтобы по каждой теме можно было быстро перейти к полезным материалам и релевантному решению."
          />
