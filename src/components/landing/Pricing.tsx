  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        'Расчет конфигурации в личном кабинете'
      ],
      limitations: [],
      buttonText: 'Открыть конструктор',
  ...
  const faqs = [
    {
      ...
      answer: 'Да, у нас есть бесплатный тариф "Free" без ограничений по времени. Он включает базовый рабочий контур для знакомства с системой.',
    ...
    },
    {
      ...
      answer: 'Базовая поддержка включена в тарифы. Расширенные условия сопровождения для Enterprise фиксируются в коммерческом предложении и договоре.',
