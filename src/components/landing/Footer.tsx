        ...
        <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr_0.8fr]">
          <div>
            ...
            <p className="mt-6 max-w-xl text-sm leading-7 text-white/70">
              Система управления строительными проектами. Объединяем объекты, команду, снабжение
              и финансы в одном месте — чтобы вы контролировали бизнес, а не гасили пожары.
            </p>
