...
const faqData = [
  {
    id: 'item-contractor-referral',
    question: "Как работает партнерская программа для приглашения подрядчиков?",
    answer: "Приглашение подрядчика бесплатно. Если приглашенная организация впервые оплачивает подписку, пригласившая организация получает бонус на баланс ProHelper. Начисление выполняется после окончания первого оплаченного периода, если подписка не была отменена заранее. Бонус нельзя вывести деньгами: его можно использовать внутри сервиса для подписки, пакетов и дополнительных модулей."
  },
  {
    id: 'item-1',
