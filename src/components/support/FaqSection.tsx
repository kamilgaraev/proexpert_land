...
const faqData = [
  ...
  },
  {
    ...
    answer: "Да, в зависимости от вашего тарифного плана, вы можете добавлять пользователей и назначать им нужные роли. Перейдите в раздел 'Участники', чтобы отправить приглашения новым пользователям по email."
  },
  {
    id: 'item-6',
