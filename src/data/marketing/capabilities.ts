...
export const marketingCapabilityMatrix: MarketingCapability[] = [
  ...
  },
  {
    ...
    publicClaim:
      "У каждой заявки с площадки есть карточка, статус, объект и ответственный, доступные офису.",
    audiences: ["Подрядчик", "Генподрядчик"],
    outcomes: [
      "Площадка и офис работают с одной карточкой заявки.",
      "Для заявки фиксируются статус и ответственный.",
  ...
  },
  {
    ...
    outcomes: [
      "Потребности по объекту передаются в закупку со статусом и ответственным.",
  ...
  },
  {
    ...
    outcomes: [
      ...
      "Руководителю доступен реестр обязательств по объектам.",
    ],
    surfaces: ["admin", "lk"],
    maturity: "stable",
  ...
  },
  {
    ...
    publicClaim:
      "Карточка дефекта содержит статус устранения, ответственного, срок и результат повторной проверки.",
  ...
  },
  {
    ...
    publicClaim:
      "Для изменения фиксируются основание, решение заказчика, влияние на сроки, бюджет и комплект документов.",
  ...
  },
  {
    ...
    outcomes: [
      "Панели показывают доступные показатели по проектам, финансам и ресурсам.",
      "Срезы по объектам содержат статусы и отклонения из рабочих данных.",
      "Отчёты формируются из записей, которые команда ведёт в системе.",
    ],
  ...
  },
  {
    ...
    outcomes: [
      ...
      "Приглашения и ответы хранятся в карточке подбора подрядчика.",
