...
describe('коммерческий каталог пакетов', () => {
  ...
  it('фиксирует серверные описания, акценты и бизнес-результаты всех пакетов', () => {
    expect(commercialPackages.map((item) => ({
      ...
      { slug: 'projects-processes', description: 'Управление объектами, рабочими процессами и заявками с площадки в одной системе.', highlights: ['Заявки с объекта', 'Файлы и документы'], outcomes: ['Единый порядок работы по объектам', 'Связь офиса и строительной площадки'] },
