...
export const marketingSolutionSegments: MarketingSolutionSegment[] = [
  {
    ...
    transformation:
      'ProHelper помогает собрать объект, заявки, документы и базовый финансовый поток в один рабочий контур без перегрузки лишними направлениями.',
    workflows: [
  ...
  },
  {
    ...
    transformation:
      'ProHelper помогает собрать корпоративный контур с разграничением доступа, ПИР, изменениями и сводной отчетностью без потери управляемости.',
    workflows: [
  ...
  },
  {
    ...
    transformation:
      'ProHelper связывает качество, дефекты, исполнительную документацию, punch-list и приемку в один управляемый маршрут.',
    workflows: [
  ...
  },
  {
    ...
    transformation:
      'ProHelper собирает ресурсный факт по объектам и связывает его с объемами, сроками, бюджетом и подготовкой начислений.',
    workflows: [
