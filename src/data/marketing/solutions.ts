...
export const marketingSolutionSegments: MarketingSolutionSegment[] = [
  ...
  },
  {
    ...
    audience:
      "Команда, которая работает с ПИР, сметами, актами, исполнительной документацией и подготовкой проекта.",
    challenge:
    ...
    workflows: [
      "Проектная и рабочая документация, формат IFC для информационных моделей и версии",
  ...
  },
  {
    ...
    challenge:
      "Дефекты, фото, повторные проверки, перечень замечаний при приёмке (punch-list) и исполнительная документация часто ведутся отдельно, поэтому риски сдачи видны слишком поздно.",
    transformation:
    ...
    workflows: [
      ...
      "Приёмка зон и перечень замечаний",
  ...
  },
  {
    ...
    workflows: [
      ...
      "Изменения к договору и дополнительные работы",
