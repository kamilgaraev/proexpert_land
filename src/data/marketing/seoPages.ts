...
export const marketingSeoLandingPages: Record<string, MarketingSeoLandingPage> = {
  ...
  'construction-crm': {
    ...
    description:
      'CRM для строительной компании помогает связать объекты, задачи, договоры, коммуникации и исполнение в одном рабочем контуре ProHelper.',
    supportingQueries: [
    ...
    automationTitle: 'Что автоматизирует',
    automationDescription: 'ProHelper связывает объект, договоры, статусы, исполнение и координацию команды в один рабочий процесс.',
    automations: [
  ...
  'pir-project-documentation': createOperationalSeoPage({
    ...
    description:
      'ProHelper помогает вести ПИР, проектные версии, ПД, РД, BIM/IFC, замечания, нормоконтроль, статусы и выпуск комплектов в одном рабочем контуре.',
    supportingQueries: [
      'пир в строительстве',
  ...
  'construction-safety': createOperationalSeoPage({
    ...
    description:
      'ProHelper помогает вести инструктажи, наряды-допуски, нарушения, инциденты, предписания и контроль устранения в проектном контексте.',
    supportingQueries: [
  ...
  'construction-quality-control': createOperationalSeoPage({
    ...
    description:
      'ProHelper помогает вести инспекции, дефекты, ответственных, сроки устранения, фотофиксацию, повторную проверку и связь с приемкой.',
    supportingQueries: [
  ...
  'handover-acceptance': createOperationalSeoPage({
    ...
    description:
      'ProHelper помогает вести приемку зон, punch-list, замечания заказчика, готовность передачи, статусы устранения и комплект сдачи объекта.',
    supportingQueries: [
  ...
  'machinery-and-labor': createOperationalSeoPage({
    ...
    description:
      'ProHelper помогает вести технику, механизмы, смены, простои, ГСМ, наряды, бригады, фактическую выработку и подготовку начислений.',
    supportingQueries: [
  ...
  'change-control': createOperationalSeoPage({
    ...
    description:
      'ProHelper связывает запросы информации, change orders, влияние на сроки и бюджет, претензии, документы и решения заказчика.',
    supportingQueries: [
      'RFI в строительстве',
