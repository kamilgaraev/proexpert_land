...
export const marketingSeoLandingPages: Record<string, MarketingSeoLandingPage> = {
  ...
  'construction-crm': {
    ...
    proof: createProof({
      title: 'Как выглядит операционная CRM в стройке',
      description: 'Здесь важно не только фиксировать запрос, но и вести объект, договорной процесс и исполнение в одном рабочем слое.',
      signals: [
