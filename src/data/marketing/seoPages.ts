...
export const marketingCommercialLandingLinks: MarketingContentLink[] = [
  {
    label: "Электронный общий журнал работ",
    href: marketingPaths.generalWorkJournal,
    description:
      "Ежедневные записи, фактические объёмы, ресурсы, согласование и экспорт по объекту.",
  },
  {
...
export const marketingRoleLandingLinks: MarketingContentLink[] = [
  marketingCommercialLandingLinks[1],
  marketingCommercialLandingLinks[5],
  {
    label: "Для снабженца",
    href: marketingPaths.materialAccounting,
    description:
...
export const marketingModuleLandingLinks: MarketingContentLink[] = [
  {
    ...
    href: marketingPaths.generalWorkJournal,
    description:
      "Ежедневные записи, объёмы, ресурсы и согласование по объекту.",
  },
  {
...
export const marketingSeoLandingPages: Record<string, MarketingSeoLandingPage> =
  {
    "general-work-journal": createOperationalSeoPage({
      path: marketingPaths.generalWorkJournal,
      eyebrow: "Рабочий день объекта",
      title: "Электронный общий журнал работ — в МОСТ",
      description:
        "Ведите ежедневные записи по объекту: работы и объёмы, люди, техника, материалы, условия, замечания и согласование. Данные связываются со сметой, графиком и исполнительными документами.",
      supportingQueries: [
        "электронный общий журнал работ",
        "общий журнал работ в строительстве",
        "электронный журнал работ в строительстве",
        "журнал работ на объекте",
      ],
      processComparison: createProcessComparison({
        eyebrow: "Один источник факта",
        ...
        metrics: [
          {
            label: "Площадка",
            value: "Ежедневная запись",
            description: "Работы, объёмы и ресурсы относятся к выбранной дате и объекту.",
          },
          {
            label: "Проверка",
            value: "Согласованный факт",
            description: "Ответственный принимает запись или возвращает её с причиной.",
          },
          {
            label: "Документы",
            value: "Связанные данные",
            description: "Записи используются в смете, графике и исполнительной документации.",
          },
        ],
      }),
      audienceTitle: "Кто работает с журналом",
      audienceDescription:
        "Прораб фиксирует день, ПТО проверяет состав данных, руководитель видит подтверждённый факт по объекту.",
      audiences: [
        "Прорабу — для ежедневной фиксации работ и ресурсов на площадке.",
        "Инженеру ПТО — для проверки записей и подготовки документов.",
        "Руководителю проекта — для сопоставления факта со сметой и графиком.",
      ],
      problemTitle: "Факт работ распадается между чатами и таблицами",
      problemDescription:
        "Когда объёмы, люди, техника и материалы записаны отдельно, невозможно быстро восстановить картину рабочего дня.",
      problems: [
        "Выполненный объём не связан с позицией сметы и задачей графика.",
        "Данные о людях, технике и материалах собираются повторно.",
        "ПТО получает запись поздно и без истории согласования.",
      ],
      automationTitle: "Что хранит МОСТ",
      automationDescription:
        "Каждая запись относится к объекту и дате, содержит производственный факт и проходит управляемый маршрут проверки.",
      automations: [
        "Описание работ, фактические объёмы и связь со сметой.",
        "Людей, технику, материалы, погоду и замечания за день.",
        "Статус согласования, ответственного и историю решения.",
        "Подготовку экспорта журнала в фоновом режиме.",
      ],
      visibilityTitle: "Один рабочий день для всей команды",
      visibilityDescription:
        "Площадка, ПТО и руководитель работают с одной записью, но каждый видит нужный ему уровень детализации.",
      roleViews: [
        {
          role: "Прораб",
          description: "Запись дня, выполненные объёмы, люди, техника и материалы.",
        },
        {
          role: "Инженер ПТО",
          description: "Комплектность записи, замечания и связь с исполнительными документами.",
        },
        {
          role: "Руководитель проекта",
          description: "Согласованный факт, план-факт по смете и связь с графиком.",
        },
      ],
      workflow: {
        title: "Как проходит запись",
        description:
          "Факт появляется на площадке, проверяется ответственным и остаётся частью истории объекта.",
        stages: [
          {
            label: "Фиксация",
            description: "Прораб создаёт запись за день и указывает выполненные работы.",
          },
          {
            label: "Ресурсы",
            description: "К записи добавляются объёмы, люди, техника и материалы.",
          },
          {
            label: "Согласование",
            description: "Ответственный принимает запись или возвращает её с причиной.",
          ...
          {
            label: "Использование",
            description: "Подтверждённый факт доступен для контроля и подготовки документов.",
          },
        ],
      },
      relatedLinks: [
        {
          label: "Программа для прораба",
          href: marketingPaths.foremanSoftware,
          description: "Ежедневные задачи и работа команды на площадке.",
        },
        {
          label: "Система для ПТО",
          href: marketingPaths.ptoSoftware,
          description: "Проверка факта и подготовка исполнительной документации.",
        },
        {
          label: "Графики и управление объектом",
          href: marketingPaths.features,
          description: "Связь журнала с другими процессами строительства.",
        },
      ],
      blogLinks: getMarketingBlogLinks("foremanOrder", "managerMorning"),
      contactHighlights: [
        "Покажем запись дня с объёмами, людьми, техникой и материалами.",
        "Покажем согласование и связь факта со сметой и графиком.",
        "Разберём ваш порядок ведения общего журнала работ.",
      ],
      faq: [
        {
          question: "Можно ли вести журнал с телефона на объекте?",
          answer:
            "Да. Мобильный сценарий позволяет работать с записями непосредственно на площадке.",
        },
        {
          question: "Журнал связан со сметой и графиком?",
          answer:
            "Да. Фактические объёмы можно сопоставлять с позициями сметы, а работы — с задачами графика.",
        },
        {
          question: "Записи проходят согласование?",
          answer:
            "Да. Запись можно отправить на проверку, принять или вернуть с указанием причины.",
        },
        {
          question: "Можно ли выгрузить журнал?",
          answer:
            "Да. Экспорт формируется в фоновом режиме, а его состояние отображается в системе.",
        },
      ],
    }),
    "foreman-software": {
        ...
        metrics: [
          {
            ...
            description: "Прораб видит назначенные работы по участкам.",
          },
          {
            label: "Факт",
            value: "Запись с фото",
            description: "Подтверждение хранится у задачи.",
          },
          {
            label: "Отклонение",
        ...
        metrics: [
          {
            ...
            description: "Контакты и договорённости собраны в карточке.",
          },
          {
            label: "Договор",
            value: "Статус этапа",
            description: "У согласования есть текущий статус.",
          },
          {
            label: "Обязательство",
            value: "Ответственный",
        ...
        metrics: [
          {
            ...
            description: "Материалы и контрагенты сопоставлены.",
          },
          {
            label: "Бюджет",
            value: "Связь с основанием",
            description: "План и факт связаны с документами.",
          },
          {
            label: "Учёт",
        ...
        metrics: [
          {
            ...
            description: "Количество добавлено в выбранное место.",
          },
          {
            label: "Движение",
            value: "Маршрут материала",
            description: "Материал передан между объектами или складами.",
          },
          {
            label: "Использование",
    ...
    "pto-software": {
      ...
      title: "Программа для ПТО в строительстве",
      description:
        "МОСТ хранит комплекты исполнительной документации, статусы и замечания по объектам. Документы готовят и проверяют ответственные специалисты.",
      supportingQueries: [
        "программа для пто",
        "система для пто",
        ...
        metrics: [
          {
            ...
            description: "ПТО видит обязательные и полученные документы.",
          },
          {
            label: "Проверка",
            value: "Записи замечаний",
            description: "Исправления связаны с конкретным материалом.",
          },
          {
            label: "Готовность",
      ...
      faq: [
        {
          question: "Что проверить в комплекте перед передачей заказчику?",
          answer:
            "Сверьте перечень документов с конкретным этапом работ: наличие материалов, актуальную версию, результат проверки и незакрытые замечания. Например, приложенный акт ещё не означает готовность комплекта, если к нему ожидается исполнительная схема. В перечне ПТО должны быть видны оба документа и ответственные за подготовку.",
        },
        {
    ...
    "contractor-control": {
      ...
      title: "Система контроля работы подрядчиков: договор и срок",
      description:
      ...
      supportingQueries: [
        "система контроля работы подрядчиков",
        ...
        metrics: [
          {
            ...
            description: "Работа и срок связаны с подрядчиком.",
          },
          {
            label: "Исполнение",
            value: "Запись объёма",
            description: "Факт хранится с подтверждением.",
          },
          {
            label: "Приёмка",
        ...
        metrics: [
          {
            label: "Документ",
            value: "Запись версии",
            description: "Пользователь видит актуальный материал.",
          },
          {
            label: "Решение",
            value: "Статус согласования",
            description: "Статус и автор записаны в истории.",
          },
          {
            label: "Хранение",
        ...
        metrics: [
          {
            ...
            description: "Статьи и лимиты заданы по объекту.",
          },
          {
            label: "Будущие расходы",
            value: "Связь обязательств",
            description: "Заявки и договоры учтены до оплаты.",
          },
          {
            label: "Исполнение",
            value: "Запись факта",
    ...
    "mobile-app": {
      ...
      automationDescription:
        "Мобильное приложение работает как часть единого процесса стройки.",
      automations: [
      ...
      relatedLinks: [
        ...
        },
        {
          ...
          href: marketingPaths.materialAccounting,
          description:
            "Если мобильное приложение нужно прежде всего для снабжения и приемки.",
        },
      ],
      ...
      faq: [
        {
          ...
          answer:
            "Да, мобильное приложение поддерживает задачи, замечания, фотофиксацию и статусы по объекту.",
        },
        {
          question:
        ...
        },
        {
          ...
          answer:
            "Нет, мобильное приложение является частью общей системы МОСТ и связано с работой офиса.",
        },
        {
          question: "Все ли функции доступны без связи?",
          answer:
            "Нет. Доступность действий зависит от роли пользователя, настроек компании и качества связи на объекте.",
        },
      ],
    },
    "ai-estimates": {
      ...
      audienceTitle: "Кому подходит",
      audienceDescription:
        "Для команд, которым нужен предварительный разбор чертежа перед самостоятельным сметным расчётом.",
      audiences: [
        "Сметчикам и техническим специалистам, которые проверяют исходные данные чертежа перед расчётом.",
      ...
      problemTitle: "Какие задачи решает",
      problemDescription:
        "Автоматический разбор помогает подготовить исходные данные, но не заменяет сметчика и инженерную оценку.",
      problems: [
        "Чертёж поступает без подготовленной структуры для проверки объёмов.",
        "Неочевидные элементы требуют отдельного внимания сметчика.",
        "Предварительный результат нужно сопоставить с нормами и условиями проекта.",
      ],
      automationTitle: "Что автоматизирует",
      automationDescription:
        "Система формирует предварительную структуру для последующей проверки специалистом.",
      automations: [
        ...
        "Передачу предварительной оценки в общую систему МОСТ.",
      ],
      visibilityTitle: "Что видит команда",
      visibilityDescription:
        "Команда видит исходный чертёж, результат разбора и обязательный этап экспертной проверки.",
      roleViews: [
        {
          role: "Сметчик",
          description:
        ...
        },
        {
          ...
          description:
            "Статус предварительного разбора и вопросы, переданные сметчику.",
        },
        {
      ...
      workflow: {
        title: "Как проходит предварительный разбор чертежа",
        description:
      ...
      relatedLinks: [
        ...
        },
        {
          ...
          href: marketingPaths.constructionErp,
          description:
            "Если оценка с помощью AI должна стать частью общей системы управления стройкой.",
        },
        {
          label: "Возможности МОСТ",
          href: marketingPaths.features,
          description:
            "Смотреть, как предварительный разбор связан с объектом, документами и аналитикой.",
        },
      ],
      blogLinks: [{ ...allBlogArticlesLink }],
      contactHighlights: [
        "Покажем исходные данные, результат предварительного разбора и порядок экспертной проверки.",
        "Разберем, как использовать оценку с помощью AI в общей системе МОСТ.",
        "Обсудим качество входных данных и практический формат пилота.",
      ],
      faq: [
        {
          question: "Заменяет ли AI-смета сметчика полностью?",
          answer:
            "Нет. Это предварительный разбор, а не готовая смета; результат обязательно проверяет специалист.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Нет, предварительный разбор можно использовать как подготовительный этап, если специалист затем проверяет результат.",
        },
      ],
    },
