...
export const marketingSalesOffers: MarketingSalesOffer[] = [
  ...
  },
  {
    ...
    audience: 'До 10 пользователей, несколько объектов, нужны снабжение, финансы и контроль исполнения.',
  ...
  },
  {
    ...
    audience: 'Группа компаний, генподрядчик или девелопер со 100+ пользователями, несколькими юрлицами и сложной структурой доступа.',
    packageSlugs: ['holding-analytics', 'finance-acts', 'ai-contour'],
    outcome: 'Enterprise Конструктор включает корпоративные уровни пакетов, расширенные лимиты и расчет стандартной конфигурации без ручного согласования.',
