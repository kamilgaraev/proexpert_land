    ...
    tiers: [
      {
        ...
        priceLabel: 'от 4 900 ₽/мес',
        billingModel: 'subscription',
        moduleSlugs: ['project-management', 'catalog-management', 'workflow-management', 'contract-management', 'payments', 'act-reporting'],
  ...
  },
  {
    ...
    tiers: [
      ...
      },
      {
        ...
        priceLabel: 'от 7 900 ₽/мес',
        billingModel: 'subscription',
        moduleSlugs: ['project-management', 'contract-management', 'catalog-management', 'budget-estimates', 'rate-management', 'reports', 'report-templates'],
      ...
      },
      {
        ...
        priceLabel: 'от 11 900 ₽/мес',
        billingModel: 'subscription',
        moduleSlugs: ['project-management', 'contract-management', 'catalog-management', 'budget-estimates', 'ai-estimates', 'file-management', 'rate-management', 'reports', 'report-templates'],
...
export const marketingSalesOffers: MarketingSalesOffer[] = [
  {
    ...
    outcome: 'Start уже включает объектный контур: объекты, договоры и ответственные без доплаты за первый пакет.',
  ...
  },
  {
    ...
    outcome: 'Profi дает пакеты уровня Рост, Enterprise расширяет их до корпоративного уровня с интеграциями и сопровождением запуска.',
