...
export const marketingSalesOffers: MarketingSalesOffer[] = [
  ...
  },
  {
    ...
    packageSlugs: ['holding-analytics', 'finance-acts', 'ai-contour', 'site-quality-handover'],
    outcome: 'Enterprise Конструктор включает корпоративные направления, расширенные лимиты и расчет стандартной конфигурации без ручного согласования.',
