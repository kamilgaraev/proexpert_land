...
export const marketingSeo: Record<string, MarketingSeoMeta> = {
  home: {
    title: 'Программа для строительной компании и управления стройкой | ProHelper',
    description:
  ...
  contractors: {
    title: 'Программа для подрядчика и контроля строительных работ | ProHelper',
    description:
  ...
  developers: {
    title: 'Система для девелопера и контроля строительных проектов | ProHelper',
    description:
