...
export const marketingSeo: Record<string, MarketingSeoMeta> = {
  home: {
    ...
    description:
      'ProHelper — программа для строительной компании: управление объектами, снабжением, документами, подрядчиками и финансами в одной системе.',
    keywords:
  ...
  features: {
    title: 'Возможности ProHelper для стройки: объект, снабжение, финансы',
    description:
      'Возможности ProHelper: контроль объекта, учет материалов, документы, подрядчики, финансы и управленческая аналитика для стройки.',
    keywords:
