...
export const marketingSeo: Record<string, MarketingSeoMeta> = {
  home: {
    title: 'Программа для управления строительством | ProHelper',
    description:
      'ProHelper — программа для строительной компании: объекты, ПИР, снабжение, финансы, качество, охрана труда, ресурсы, изменения и документы в одной системе.',
    keywords:
      'программа для строительной компании, система управления строительством, пир в строительстве, охрана труда на стройке, контроль качества строительства, ProHelper',
  },
  solutions: {
    title: 'Решения для подрядчика, генподрядчика и девелопера | ProHelper',
    description:
      'Решения ProHelper для подрядчика, генподрядчика, девелопера, ПТО и инженерной команды. Подбираем сценарий запуска под роли и процессы.',
    keywords:
      'решения для строительной компании, для подрядчика, для генподрядчика, для девелопера, система для пто',
  },
  features: {
    title: 'Возможности ProHelper: объект, ПИР, качество, HSE, ресурсы',
    description:
      'Возможности ProHelper: объект, ПИР, снабжение, финансы, качество, охрана труда, техника, выработка, изменения и управленческая аналитика.',
    keywords:
  ...
  pricing: {
    ...
    description:
      'Пакеты ProHelper для строительной компании: объект, ПИР, снабжение, финансы, качество, охрана труда, техника, персонал, изменения и аналитика.',
    keywords:
      'стоимость prohelper, пакеты prohelper, внедрение системы для стройки, программа для строительной компании цена',
  },
  integrations: {
    title: 'Интеграции с 1С, ERP и BI для строительной компании | ProHelper',
    description:
      'Интеграции ProHelper с 1С, ERP, BI и корпоративными системами, чтобы связать стройку, документы, финансы и отчетность в одном контуре.',
    keywords:
      'интеграция 1с строительство, erp для строительства, api для стройки, интеграция строительной системы',
  },
  contractors: {
    title: 'Программа для подрядчика в строительстве | ProHelper',
    description:
      'ProHelper помогает подрядчику управлять объектом, задачами, снабжением, документами и сроками работ в единой строительной системе.',
    keywords:
      'программа для подрядчика, управление строительными работами, система для подрядчика, программа для стройки',
  },
  developers: {
    title: 'Система для девелопера в строительстве | ProHelper',
    description:
      'ProHelper для девелопера: контроль подрядчиков, сроков, бюджета, документов и управленческой отчетности по объектам.',
    keywords:
      'система для девелопера, контроль строительных проектов, контроль подрядчиков, цифровизация девелопера',
  },
  enterprise: {
    title: 'Enterprise-платформа для строительного холдинга | ProHelper',
    description:
      'Enterprise-решение ProHelper для строительных холдингов и крупных компаний: единые стандарты, роли, аналитика и масштабируемый запуск.',
    keywords:
  ...
  blog: {
    title: 'Блог ProHelper о цифровизации строительства и рабочих процессах',
    description:
      'Блог ProHelper о цифровизации строительства: графики работ, учет материалов, контроль подрядчиков, документы, бюджет стройки и запуск системы.',
    keywords:
      'блог о строительстве, цифровизация строительства, учет материалов, контроль подрядчиков, статьи prohelper',
  },
  'foreman-software': {
    title: 'Программа для прораба: задачи и контроль работ | ProHelper',
    description:
      'Программа для прораба ProHelper: задачи, замечания, фотофиксация, график работ и контроль исполнения на объекте в единой системе.',
    keywords:
      'программа для прораба, приложение для прораба, учет работ на объекте, контроль графика работ',
  },
  'construction-crm': {
    title: 'CRM для строительной компании: объекты и задачи | ProHelper',
    description:
      'CRM для строительной компании ProHelper связывает объекты, задачи, договоры, статусы исполнения и управленческий контроль в одной системе.',
    keywords:
  ...
  'pir-project-documentation': {
    title: 'ПИР и проектная документация в строительстве | ProHelper',
    description:
      'Контур ПИР в ProHelper помогает управлять ПД, РД, BIM/IFC, замечаниями, нормоконтролем, версиями и выпуском комплектов проектной документации.',
    keywords:
      'пир в строительстве, проектная документация, пд рд, управление проектированием, нормоконтроль, bim ifc',
  },
  'construction-safety': {
    title: 'Охрана труда на стройке: инструктажи, допуски, инциденты | ProHelper',
    description:
      'Охрана труда на стройке в ProHelper: инструктажи, наряды-допуски, нарушения, инциденты, предписания и контроль устранения по объектам.',
    keywords:
      'охрана труда на стройке, безопасность в строительстве, инструктажи и допуски, инциденты на объекте',
  },
  'construction-quality-control': {
    title: 'Контроль качества строительства и дефектов | ProHelper',
    description:
      'Контроль качества строительства в ProHelper: инспекции, дефекты, замечания, фотофиксация, ответственные, сроки и повторная проверка.',
    keywords:
      'контроль качества строительства, строительный контроль дефекты, инспекции качества, замечания на стройке',
  },
  'handover-acceptance': {
    title: 'Приемка зон и punch-list в строительстве | ProHelper',
    description:
      'Приемка зон и punch-list в ProHelper помогают передавать результат заказчику, контролировать замечания, статусы устранения и готовность к сдаче.',
    keywords:
      'приемка зон строительство, punch list стройка, сдача объекта заказчику, контроль замечаний при приемке',
  },
  'machinery-and-labor': {
    title: 'Учет техники, механизмов, нарядов и выработки | ProHelper',
    description:
      'Учет техники и выработки в ProHelper: механизмы, смены, простои, ГСМ, наряды, бригады, объемы работ и подготовка начислений.',
    keywords:
      'учет техники на стройке, учет механизмов, наряды в строительстве, выработка бригад, сменные рапорты',
  },
  'change-control': {
    title: 'RFI, изменения и претензии в строительстве | ProHelper',
    description:
      'Контур изменений в ProHelper связывает RFI, change orders, дополнительные работы, претензии, документы и влияние на сроки и бюджет.',
    keywords:
