  ...
  const mainNavigation = useMemo(() => {
    ...
    const allNavigationItems = [
      ...
      },
      {
        ...
        aliases: ['компания', 'организация', 'направления работы', 'профиль организации', 'специализации'],
      ...
      },
      {
        ...
        icon: Users,
        description: 'Сотрудники, роли и доступ к кабинету',
        aliases: ['команда', 'сотрудники', 'права доступа', 'роли', 'пользователи', 'доступ'],
